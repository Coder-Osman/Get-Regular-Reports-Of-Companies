        ...
        for comName in comNames :
            ...
            if sameName == False :
                try :
                    ...
                    while cnt < sum :
                        ...
                        for i in res :
                            ...
                            if "PDF" in adjunctUrl :
                                ...
                                pdfs.append (res2)
                                ptitle.append (title)
                                self.textBrowser.append ("A股" + title + "okay")
                                ...
                                dtitle.append (title)
                                self.textBrowser.append("A股" + title + "text")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                            else :
                                res2 = requests.get("http://static.cninfo.com.cn/%s" % adjunctUrl)
                                ...
                                js.append(b.strip())
                                jtitle.append(title)
                                self.textBrowser.append("A股" + title + "javascript")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                        page += 1
                except:
                    ...
                    bug.append(comName)
            if error :
                self.textBrowser.append ("A股" + comName + "爬取时出错")
                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                QtWidgets.QApplication.processEvents()
            elif sameName:
                self.textBrowser.append("A股" + comName + "已经爬取过")
                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                QtWidgets.QApplication.processEvents()
                same.append(comName)
            elif cnt == 0 :
                try :
                    ...
                    if cnt == 0 :
                        ...
                        self.textBrowser.append("A股" + comName + "over")
                        self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                        QtWidgets.QApplication.processEvents()
                        ct = 0
                        os.mkdir(cwd)
            ...
            if sameName == False :
                try :
                    ...
                    while cnt < sum :
                        ...
                        for i in res :
                            ...
                            if "PDF" in adjunctUrl :
                                ...
                                pdfs.append (res2)
                                ptitle.append (title)
                                self.textBrowser.append ("港股" + title + "okay")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                            elif ".html" in adjunctUrl :
                                res2 = requests.get("http://static.cninfo.com.cn/%s" % adjunctUrl)
                                ...
                                docxs.append (b.strip ())
                                dtitle.append (title)
                                self.textBrowser.append("港股" + title + "text")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                            else :
                                res2 = requests.get("http://static.cninfo.com.cn/%s" % adjunctUrl)
                                ...
                                js.append(b.strip())
                                jtitle.append(title)
                                self.textBrowser.append("港股" + title + "javascript")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                        page += 1
                except:
                    ...
                    bug.append(comName)
            if error :
                self.textBrowser.append ("港股" + comName + "爬取时出错")
                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                QtWidgets.QApplication.processEvents()
            elif sameName:
                self.textBrowser.append("港股" + comName + "已经爬取过")
                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                QtWidgets.QApplication.processEvents()
                same.append(comName)
            elif cnt == 0 :
                try :
                    ...
                    if cnt == 0 :
                        ...
                        self.textBrowser.append("港股" + comName + "over")
                        self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                        QtWidgets.QApplication.processEvents()
                        ct = 0
                        os.mkdir(cwd)
            ...
            if sameName == False :
                try :
                    ...
                    while cnt < sum :
                        ...
                        for i in res :
                            ...
                            if "PDF" in adjunctUrl :
                                ...
                                pdfs.append (res2)
                                ptitle.append (title)
                                self.textBrowser.append ("三板" + title + "okay")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                            elif ".html" in adjunctUrl :
                                res2 = requests.get("http://static.cninfo.com.cn/%s" % adjunctUrl)
                                ...
                                docxs.append (b.strip ())
                                dtitle.append (title)
                                self.textBrowser.append("三板" + title + "text")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                            else :
                                res2 = requests.get("http://static.cninfo.com.cn/%s" % adjunctUrl)
                                ...
                                js.append(b.strip())
                                jtitle.append(title)
                                self.textBrowser.append("三板" + title + "javascript")
                                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                                QtWidgets.QApplication.processEvents()
                        page += 1
                except:
                    ...
                    bug.append(comName)
            if error :
                self.textBrowser.append ("三板" + comName + "爬取时出错")
                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                QtWidgets.QApplication.processEvents()
            elif sameName:
                self.textBrowser.append("三板" + comName + "已经爬取过")
                self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                QtWidgets.QApplication.processEvents()
                same.append(comName)
            elif cnt == 0 :
                try :
                    ...
                    if cnt == 0 :
                        ...
                        self.textBrowser.append("三板" + comName + "over")
                        self.textBrowser.moveCursor(self.textBrowser.textCursor().End)
                        QtWidgets.QApplication.processEvents()
                        ct = 0
                        os.mkdir(cwd)
